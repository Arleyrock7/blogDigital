...
<?php
	...
	global $class_masonry_full;
	if ( $revalia_layoutsidbarcat == 'fullwidth'){ $class_masonry_full = '-full'; }
?>

<div class="blog-posts-masonry<?php echo esc_attr($class_masonry_full); ?> masonry-blog">
...
<script>
	jQuery(document).ready(function($) {
		var msnry = new Masonry( '.masonry-blog', {
		  // options
		  columnWidth: '',
		});
	});
